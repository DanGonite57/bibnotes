...
export class SettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(settingsExport)
			.setName("Note Title")
			.setDesc(
				"Select the format of the title of the note. Possible values include: {{citeKey}}, {{title}}, {{author}}, {{year}}"
			)
			.addText((text) =>
				text
		...
		new Setting(settingsHighlights).setName("Bold").addToggle((text) =>
			text.setValue(settings.isHighlightBold).onChange(async (value) => {
				settings.isHighlightBold = value;
				await plugin.saveSettings();
				this.display();
			})
		);
		new Setting(settingsHighlights).setName("Italic").addToggle((text) =>
			text
		...
		new Setting(settingsComments).setName("Bold").addToggle((text) =>
			text.setValue(settings.isCommentBold).onChange(async (value) => {
		...
		new Setting(settingsComments).setName("Italic").addToggle((text) =>
			text.setValue(settings.isCommentItalic).onChange(async (value) => {
		...
		new Setting(settingsComments).setName("Highlighted").addToggle((text) =>
			text
		...
		new Setting(settingsComments).setName("Blockquote").addToggle((text) =>
			text
		...
		new Setting(settingsTags).setDesc(
		...
		/*
				...
				new Setting(settingsTags)
					...
					*/
		new Setting(settingsTags).setName("Hash sign (#)").addToggle((text) =>
			text.setValue(settings.isTagHash).onChange(async (value) => {
				settings.isTagHash = value;
				await plugin.saveSettings();
				this.display();
			})
		);
		new Setting(settingsTags).setName("Quotation Marks").addToggle((text) =>
			text.setValue(settings.isTagQuote).onChange(async (value) => {
		...
		new Setting(settingsTags).setName("Bold").addToggle((text) =>
			text.setValue(settings.isTagBold).onChange(async (value) => {
		...
		new Setting(settingsTags).setName("Italic").addToggle((text) =>
			text.setValue(settings.isTagItalic).onChange(async (value) => {
		...
		new Setting(settingsTags).setName("Highlighted").addToggle((text) =>
			text.setValue(settings.isTagHighlighted).onChange(async (value) => {
				settings.isTagHighlighted = value;
				await plugin.saveSettings();
				this.display();
			})
		);
		new Setting(settingsTags).setName("Bullet Points").addToggle((text) =>
			text.setValue(settings.isTagBullet).onChange(async (value) => {
		...
		new Setting(settingsTags).setName("Blockquote").addToggle((text) =>
			text.setValue(settings.isTagBlockquote).onChange(async (value) => {
		...
		new Setting(debugSettings)
			...
			.addToggle((text) =>
				text.setValue(settings.debugMode).onChange(async (value) => {
